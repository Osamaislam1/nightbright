...
@section('content')
    <main>
        ...
        <!-- Main Content -->
        <div class="container mt-4">
            <div class="main-content p-5 bg-white rounded shadow">
                <!-- Organization Header -->
                    ...
                    <div class="col-md-3">
                        <div class="sidebar">
                            <div class="sidebar-item mb-3">
                                <img src="{{ asset('frontend/images/find.JPG') }}" alt="Find"
                                    class="img-fluid mb-2 sidebar-thumb"
                                    data-main="{{ asset('frontend/images/find.JPG') }}">
                            </div>
                            <div class="sidebar-item mb-3">
                                <img src="{{ asset('frontend/images/fund.JPG') }}" alt="Fund"
                                    class="img-fluid mb-2 sidebar-thumb"
                                    data-main="{{ asset('frontend/images/fund.JPG') }}">
                            </div>
                            <div class="sidebar-item">
                                <img src="{{ asset('frontend/images/resource.JPG') }}" alt="Resource"
                                    class="img-fluid mb-2 sidebar-thumb"
                                    data-main="{{ asset('frontend/images/resource.JPG') }}">
                            </div>
                        </div>
                    </div>
                    <div class="col-md-9">
                        <div class="main-image">
                            <img id="mainImage" src="{{ asset('frontend/images/find.JPG') }}" alt="Main Display"
        ...
        <aside id="donateSidebar" class="donate-sidebar scroll-thumb">
            ...
            <div id="donateStep1" class="donate-step active">
                <div class="donate-title">DONATE</div><button class="donate-close" id="donateCloseBtn"
                    aria-label="Close">&times;</button>

                <form class="donate-form" id="donateForm1">
                    <div class="mb-3 mt-2">
                        <label style="font-size: 15px;" class="form-label fw-semibold">Missionary Donation</label>
                        <hr class="my-2">


                        <div class="donate-tabs mb-4">
                        ...
                        <div class="row mb-3">
                            <div class="col">
                                <input type="text" class="form-control" placeholder="Donor's Name"
                                    aria-label="Donor Name" id="donorName">
                            </div>
                            <div class="col">
                                <input type="email" class="form-control" placeholder="Donor's Email"
                                    aria-label="Donor Email" id="donorEmail">
                            </div>
                        </div>
                        ...
                        <div class="donate-amounts mb-3">
                            ...
                            <input type="number" class="form-control amount-btn" id="otherAmount" placeholder="Other"
                                min="1" step="1">
                        </div>
                        <button type="button" class="btn-add-message mb-2 w-100" id="addMessageBtn">+ Add a
                            message</button>
                        <input type="text" class="form-control mb-3 custom-input" id="messageInput"
                            style="display: none;">
                        <hr class="my-2">
            ...
            <div id="donateStep2" class="donate-step">
                ...
                <div class="payment-summary mt-4">
                    ...
                    <div style="font-size: 13px;" class="d-flex justify-content-between mb-2 mt-5">
                        <span class="fw-bold">Donation</span>
                        <span id="displayDonationAmount" class="fw-bold">$25</span>
                    </div>
                    <div style="font-size: 13px;" class="d-flex justify-content-between mb-2 mt-4">
                        <span class="fw-bold">Credit card Processing fees</span>
                        <span id="processingFees" class="fw-bold processingFees">$0.00</span>
                    </div>
                    <div class="payment-method mb-3">
                        <select class="form-select payment-method-select" id="paymentMethod">
                            <option value="amex">AMEX Card</option>
                            <option value="visa">Visa &amp; Others</option>
                            <option value="usbank">US Bank Account</option>
                    ...
                    <div class="tip-section p-3 mb-3">
                        <div class="d-flex justify-content-between mb-2">
                            <span class="tip-instruction">Add a tip to support Night Bright</span>
                    ...
                    <form id="stripeForm" action="{{ route('donation.checkout') }}" method="POST">
                        ...
                        <button type="submit" class="btn btn-donate-2" id="finishDonation">Finish (<span
                                id="totalAmount">$28.00</span>)</button>
                    </form>
                </div>
            </div>

            <!-- Step 3: Loading Animation -->
            <div id="donateStep3" class="donate-step">
                <div class="donate-title">DONATE</div>
                <div class="d-flex align-items-center justify-content-center h-100 loading-container">
                    <div class="d-flex align-items-center">
                        <div class="loading-text me-2">Loading</div>
